...
def upgrade() -> None:
    ...
    op.execute(
        ...
        SELECT
            ...
            '["request", "status_update", "chat/noise"]'::jsonb,
            '{"fallback":"digest_only","media_only":"digest_only"}'::jsonb,
            '{"default":"normal","with_media_boost":false}'::jsonb,
            '{"store_preview_in_db":true,"image_max_side":1280,"image_quality":60}'::jsonb,
            '[]'::jsonb,
            '{}'::jsonb,
            '{"topic_kind":"mixed","strict_allowed_types":false}'::jsonb,
            0.65,
            true,
            now(),
            now()
